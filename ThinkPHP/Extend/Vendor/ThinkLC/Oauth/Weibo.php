...
define('WB_AKEY', $oauth['weibo']['akey']);
define('WB_SKEY', $oauth['weibo']['skey']);
define('WB_CALLBACK_URL', C('site_url').'/index.php?g=Member&m=Oauth&a=callback&site=weibo');
...
function get_oauth_info() {
	...
	$oauth_info = array();
	$oauth_info['openid'] = $user_message['id'];
	$oauth_info['nickname'] = $user_message['screen_name'];
	$oauth_info['avatar'] = $user_message['profile_image_url'];
	$oauth_info['url'] = 'http://www.weibo.com/'.$user_message['profile_url'];
	return $oauth_info;
}
function del_token() {
