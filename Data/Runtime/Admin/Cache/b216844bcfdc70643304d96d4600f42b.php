...
<div class="common-form">
    ...
    <form name="myform" id="myform" action="<?php echo U('Article/insert');?>" method="post">
        ...
        <table width="100%" class="table_form contentWrap">
            <tr>
                <td align="right" width="100">文章分类：</td>
                <td align='left'>  
...
<!--            <tr>
            ...
            <tr>
                ...
                <td id="td_pic" style="display:none;">
                    <div class="waitpic cu" style="width:<?php echo ($CFG['cell_width'][0]); ?>px;height:<?php echo ($CFG["cell_height"]); ?>px;" onclick="if($('#picurl').val()!=''){preview($('#picurl').val());return false;}doDialog('<?php echo U('Article/upload');?>','上传图片','280','100');">
                        <span id="picshow"></span>
                    </div>
                    <div style="width:<?php echo ($CFG['cell_width'][0]); ?>px;text-align:center" class="mt10">
                        <span onclick="doDialog('<?php echo U('Article/upload');?>','上传图片','280','100')" class="cu"><img src="__PUBLIC__/Images/icon/img_upload.gif" title="上传"/></span>&nbsp;&nbsp;
