...
<style>
html, body{margin:0; padding:0; border:0 none;font:14px Tahoma,Verdana;line-height:150%;background:#F2F2F2;}
...
<?php else: ?>
.layout-prompt{background: #F2F2F2;padding:12px 0px;margin:10% auto 0px auto;}
.layout-prompt .prompt{background: #FFF;margin:0px auto;border: 1px solid #CDCDCD;max-width:680px;min-height: 300px;}<?php endif; ?>
.layout-prompt .prompt-center{margin:12px 0px 0px 24px;}
...
<body>
<div class="public-success layout-prompt">
    <div class="prompt">
        <div class="prompt-center">
            <div class="title">信息提示</div>
            <div class="content cf mt">
                <div class="fl mt">
					<?php if(isset($message)): ?><img src="__PUBLIC__/Images/img_success.gif" alt="操作成功！" />
					<?php else: ?>
                    <img src="__PUBLIC__/Images/img_error.gif" alt="操作失败！" /><?php endif; ?>
                </div>
                <div class="fl ml">
                    <div class="message">
                    ...
                    <div>
					<?php if(isset($closeWin)): ?>系统将在 <span class="light"><?php echo ($waitSecond); ?></span> 秒后自动关闭，如果不想等待请点击 <a class="light" href="<?php echo ($jumpUrl); ?>">这里</a> 关闭<br/>
					<?php else: ?>
						系统将在 <span class="light"><?php echo ($waitSecond); ?></span> 秒后自动跳转，如果不想等待请点击 <a class="light" href="<?php echo ($jumpUrl); ?>">这里</a> 跳转<br/><?php endif; ?>
					</div>
                    <div>或者 <a class="light" href="__APP__">返回首页</a></div>
                </div>
            </div>
        </div>
    </div>
