...
/**
 *      [ThinkLC] (C)2001-2099 Comsenz Inc.
...
$lang = array(
	...
	'license_error' => '请检查网站根目录下 license.txt 文件是否存在或被修改<br/>使用ThinkLC地方分类信息管理系统，必须同意license.txt内容，并保留此文件<br/>如果使用FTP上传文件，请使用二进制模式上传 license.txt',
	...
	'tips_ucenter_comment' => 'UCenter 是 Comsenz 公司产品的核心服务程序，您选择了在Ucenter中添加ThinkLC应用。<br>如果您已经安装了 UCenter，请填写以下信息。<br>否则，请到 <a href="http://www.comsenz.com/products/ucenter" target="blank">Comsenz 产品中心</a> 下载并且安装，然后再继续。',
	...
	'admininfo_invalid' => '管理员信息不完整，请检查管理员账号，密码',
	...
	'install_succeed' => '<strong style="font-size:14px;">恭喜！您已经成功安装ThinkLC地方分类信息管理系统</strong><br/><br/>为了系统安全，请删除install文件夹<br/><a href="/index.php">网站前台</a><br/><a href="/admin.php">进入网站管理后台</a><br/><a href="http://www.saxue.com" target="_blank">进入ThinkLC官方网站</a><br/><br/>',
	'to_index' => '暂不开通',
	...
	'max_size' => '支持/最大尺寸',
	'project' => '项目',
	'ucenter_required' => 'ThinkLC 所需配置',
	'ucenter_best' => 'ThinkLC 最佳',
	'curr_server' => '当前服务器',
	'env_check' => '环境检查',
	'os' => '操作系统',
	'php' => 'PHP 版本',
